...
FEAT = os.path.join(BASE, "outputs_v9/features.csv")
...
def dist(a, b):
    ...
    keys = [
        "ACI_mean","ACI_std","ACI_max",
        "TCI_mean","TCI_std","TCI_max",
        "ACI_range","TCI_range"
    ]
...
if __name__ == "__main__":
    ...
    os.makedirs("outputs_v9_est", exist_ok=True)
    df_est.to_csv("outputs_v9_est/results.csv", index=False)
